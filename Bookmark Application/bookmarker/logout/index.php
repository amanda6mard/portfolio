<?php
    ...
    if ($_POST){
        ...
        if ($isLoggedIn){
            session_start();
            $_SESSION["Bookmarker"]["username"] = $username;
            $_SESSION["Bookmarker"]["userID"] = $userID;
            $_SESSION["Bookmarker"]["isLoggedIn"] = true;
    ...
    <body>
        ...
        <div id="outer-form" class="outer-form"> 
            <form id="login-box" method="post" class="login-box">
                ...
                <label>username: </label><input type="text" name="username" id="username" class="text-input">
                <label>password: </label><input type="password" name="password" id="password" class="text-input">
